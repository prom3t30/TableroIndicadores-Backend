...
use App\MetaLineaCentro; //usamos el modelo
use App\Http\Resources\MetaLineaCentro as MetaLineaCentroResource; //usamos el recurso
use App\Http\Resources\MetaLineaCentroCollection; //usamos la coleccion
