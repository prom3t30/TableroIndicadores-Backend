...
use App\Indicadores;
use App\DetalleEjecucionIndicador;
...
class EjecucionIndicadorController extends Controller
{
    ...
    public function getMetasEsperadasPorLineaPorAnio(Request $request)
    {
        ...
        array_push($valores["mes"], EjecucionIndicador::where([['mes', '=', 'Diciembre'], ['year', '=', $request->year], ['metaXLinea_id', '=', $valores["metaPorLinea"][0]->id]])->orderby('created_at', 'DESC')->take(1)->first());
